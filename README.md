...
One leg → 5V
Other leg → A0
Also connect a 10k resistor from that leg to GND (This forms a voltage divider.)
...
Place push button across the breadboard.
One side → Digital Pin 2
Same side → 5V
Other side → 10k resistor → GND (This acts as a pull-down resistor.)
...
<img width="1117" height="669" alt="image" src="https://github.com/user-attachments/assets/f69c3ee5-ec1d-4919-a8bd-e1f2a2766c55" />
...
<img width="1485" height="783" alt="image" src="https://github.com/user-attachments/assets/e9f9f951-63dc-46b4-bbcd-1d241f439903" />
